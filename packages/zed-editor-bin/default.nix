{
  ...
  assets = {
    ...
    "aarch64-linux" = {
      ...
      sha256 = "sha256-5HaPwLQSAObYLDvgmR30FVPuSYVbYahjDJsbWsi0myA=";
      type = "tar.gz";
    };
    "x86_64-darwin" = {
      url =
      ...
      sha256 = "sha256-T1y+GFPEECOjgkgZqkz7qXFSO68gMAtnbqURUocjrzc=";
      type = "dmg";
    };
    "aarch64-darwin" = {
      url =
      ...
      sha256 = "sha256-+kvLGy6624CMm8M/fRVD8U9hG6HI3QiyHNCsSYTLHIk=";
      type = "dmg";
    };
  };
