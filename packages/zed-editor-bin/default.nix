{
  ...
  assets = {
    ...
    "aarch64-linux" = {
      ...
      sha256 = "sha256-h4/sXi9HIdC094V6PXq8++/o8HABJN2kkra8d0I2CPs=";
      type = "tar.gz";
    };
    "x86_64-darwin" = {
      url =
      ...
      sha256 = "sha256-QZ0bmH9Lfxx+9diGt9xz/UP1g7WFNq+atglMyNteb1M=";
      type = "dmg";
    };
    "aarch64-darwin" = {
      url =
      ...
      sha256 = "sha256-oZM20KipDVlrA4oCSgit4WmqqmIiPAc3SRDBuNesdBM=";
      type = "dmg";
    };
  };
