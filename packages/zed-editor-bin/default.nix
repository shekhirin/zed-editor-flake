{
  ...
  assets = {
    ...
    "aarch64-linux" = {
      ...
      sha256 = "sha256-MD3y7HMlUXAOnTZ6V4Ueoi5kGtC/AK/8hU+41JvwRb0=";
      type = "tar.gz";
    };
    "x86_64-darwin" = {
      url =
      ...
      sha256 = "sha256-5jLI2YD8abWGXMWYC9572MXYN8T3GXNHnnNw+JCF9x4=";
      type = "dmg";
    };
    "aarch64-darwin" = {
      url =
      ...
      sha256 = "sha256-WdTiVWmN/f14VJ4NFzFY7fhoi3RAVTvDeHDuTH91buc=";
      type = "dmg";
    };
  };
