{
  ...
  assets = {
    ...
    "aarch64-linux" = {
      ...
      sha256 = "sha256-d0GzDeQdisvMGfPctrGIIT5u4qTAGBq8yqLOXxzX/50=";
      type = "tar.gz";
    };
    "x86_64-darwin" = {
      url =
      ...
      sha256 = "sha256-Q2kkFG58yA4zeTxyEt+WcfcZlzZGqxibDAxjF1N6yys=";
      type = "dmg";
    };
    "aarch64-darwin" = {
      url =
      ...
      sha256 = "sha256-tPCYH+TSkYQreGrSAlrtLanMlEq/gu2xIVG0FOTgVJ4=";
      type = "dmg";
    };
  };
