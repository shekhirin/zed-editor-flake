{
  ...
  assets = {
    ...
    "aarch64-linux" = {
      ...
      sha256 = "sha256-118xEPvB1nW4IUtsSXqSgvfuqWfJAzAMtluq7cKzRcg=";
      type = "tar.gz";
    };
    "x86_64-darwin" = {
      url =
      ...
      sha256 = "sha256-E21SE4MT8JFy4GqvzBz+k1CRudSXiFzUcijzE2wk8P0=";
      type = "dmg";
    };
    "aarch64-darwin" = {
      url =
      ...
      sha256 = "sha256-jAb4CVn+3rOotcVWuoc5xmVt9QzaVtXdvRjkEm95yzU=";
      type = "dmg";
    };
  };
