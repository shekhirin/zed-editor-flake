{
  ...
  assets = {
    ...
    "aarch64-linux" = {
      ...
      sha256 = "sha256-ZAnwKxO5X4JJ0kzEp/NGjnNnHSwcCBudUkvygh/krg4=";
      type = "tar.gz";
    };
    "x86_64-darwin" = {
      url =
      ...
      sha256 = "sha256-8Ruv/u/aQIcVyanPrOprfP1VKWow5uOaeF3NdLgzOVg=";
      type = "dmg";
    };
    "aarch64-darwin" = {
      url =
      ...
      sha256 = "sha256-KIU8UMoiHtFNhN3sL56kTxr+a/2oMmWl8qUsJQtb+w0=";
      type = "dmg";
    };
  };
