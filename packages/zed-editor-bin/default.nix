{
  ...
  assets = {
    ...
    "aarch64-linux" = {
      ...
      sha256 = "sha256-6JpRxNEO2eGh4QVl+lbXnHU8veyQ0xTTH36gyZfMHjE=";
      type = "tar.gz";
    };
    "x86_64-darwin" = {
      url =
      ...
      sha256 = "sha256-/u3UskTtn0J9TXpKsvTYCyZA9KgneG0qq9dnS65TrOY=";
      type = "dmg";
    };
    "aarch64-darwin" = {
      url =
      ...
      sha256 = "sha256-W3/I/rPxYuiLIg3YcTK5XhAVe9GC5JB/iRIDauqGoLQ=";
      type = "dmg";
    };
  };
