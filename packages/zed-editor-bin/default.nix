{
  ...
  assets = {
    ...
    "aarch64-linux" = {
      ...
      sha256 = "sha256-OPPFziVAtmJrm1sogOrHJ5gvD5EVPTNHUdN0Cnu9wiY=";
      type = "tar.gz";
    };
    "x86_64-darwin" = {
      url =
      ...
      sha256 = "sha256-IR8E+NBi9WohrqG580s6nMPlFUkyUewdKmNViUIHwL0=";
      type = "dmg";
    };
    "aarch64-darwin" = {
      url =
      ...
      sha256 = "sha256-BjjfniKj5wSHfQmf7tCvrGTW9T6YvaSwH1tAI5jPKz0=";
      type = "dmg";
    };
  };
