{
  ...
  assets = {
    ...
    "aarch64-linux" = {
      ...
      sha256 = "sha256-xnUH86e2h2HN3ilI9Z8UJ8vPrfXTXiPJf6N+AenHsLk=";
      type = "tar.gz";
    };
    "x86_64-darwin" = {
      url =
      ...
      sha256 = "sha256-lvzHUZKfSZrFI2sv27LCrps45ia9l1Ij3NV3UPHgu/k=";
      type = "dmg";
    };
    "aarch64-darwin" = {
      url =
      ...
      sha256 = "sha256-S4SEGWdWjvu7DYWGPF8eHc6ROI1Ci8lw7J9aKcftieM=";
      type = "dmg";
    };
  };
