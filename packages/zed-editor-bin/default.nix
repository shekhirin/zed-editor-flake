{
  ...
  assets = {
    ...
    "aarch64-linux" = {
      ...
      sha256 = "sha256-Sn2mH14LcLxvSZAuOlH4c2+OZlZp6UHCHwG3G3wvyjM=";
      type = "tar.gz";
    };
    "x86_64-darwin" = {
      url =
      ...
      sha256 = "sha256-a4uN6U7Kqi8QnBRukmvuYNvJJY6j4R5jCMxPeWsmVeU=";
      type = "dmg";
    };
    "aarch64-darwin" = {
      url =
      ...
      sha256 = "sha256-WsHbGTIqAoWVT0zV3P99Rho7Ga/SuR3xDvJV6dK5Z60=";
      type = "dmg";
    };
  };
