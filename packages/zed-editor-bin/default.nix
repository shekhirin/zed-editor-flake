{
  ...
  assets = {
    ...
    "aarch64-linux" = {
      ...
      sha256 = "sha256-5V6U3NwfsXaZypvseftlJYjHfOyHGjSGWXdncdck1zM=";
      type = "tar.gz";
    };
    "x86_64-darwin" = {
      url =
      ...
      sha256 = "sha256-C6lQ1JUUk4loiNjAfQTdgaY/9KI/6quMwmvfA7Vmcls=";
      type = "dmg";
    };
    "aarch64-darwin" = {
      url =
      ...
      sha256 = "sha256-Dz2jbngZrF1bkIUTG9Awi7fWf+usXHniyTFsn8fFMsA=";
      type = "dmg";
    };
  };
