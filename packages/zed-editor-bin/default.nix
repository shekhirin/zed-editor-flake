{
  ...
  assets = {
    ...
    "aarch64-linux" = {
      ...
      sha256 = "sha256-yqoxakzCvW5yO/OpWfs0bcFmiRSNVKNdwWYYD1SOiyM=";
      type = "tar.gz";
    };
    "x86_64-darwin" = {
      url =
      ...
      sha256 = "sha256-G7Z3o9an2cKHDJm7s27yWJxH/7skNkSl28eSpU/2Ppc=";
      type = "dmg";
    };
    "aarch64-darwin" = {
      url =
      ...
      sha256 = "sha256-I44HdnTPc4WGIaZKGn+guv4CqLzEr2yMDtwigQJ2y0Y=";
      type = "dmg";
    };
  };
