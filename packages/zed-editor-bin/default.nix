{
  ...
  assets = {
    ...
    "aarch64-linux" = {
      ...
      sha256 = "sha256-MJGI/j0aJPY2UpFBatThuVtu7wfm1lFdf15p1+lRDWY=";
      type = "tar.gz";
    };
    "x86_64-darwin" = {
      url =
      ...
      sha256 = "sha256-AXLNlm/JpEEewuA16zeQMhdrDjLpq3EXWSHSZj+/Fy8=";
      type = "dmg";
    };
    "aarch64-darwin" = {
      url =
      ...
      sha256 = "sha256-WSEUwEsy66sTIFYpBsd36BUGmGkHEb4KvV3dbzHvAsc=";
      type = "dmg";
    };
  };
