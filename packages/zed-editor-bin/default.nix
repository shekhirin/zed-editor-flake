{
  ...
  assets = {
    ...
    "aarch64-linux" = {
      ...
      sha256 = "sha256-c0racBm2q0MzZOw/T49oNYSfEspn47qAJpdztMXK6jg=";
      type = "tar.gz";
    };
    "x86_64-darwin" = {
      url =
      ...
      sha256 = "sha256-8qfNg0zAakQ0V/B+fY0qjcor4WJBFbnpTiw7SpV+q3U=";
      type = "dmg";
    };
    "aarch64-darwin" = {
      url =
      ...
      sha256 = "sha256-PBa31P4zJwGGeE4L8WBcGMfIzV0sOrCUq/zpEM8zp/I=";
      type = "dmg";
    };
  };
