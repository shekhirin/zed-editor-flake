{
  ...
  assets = {
    ...
    "aarch64-linux" = {
      ...
      sha256 = "sha256-Pwi46EqyrpD8B6WYxy6K0ojV+8in6+qYqEw1rANWcdg=";
      type = "tar.gz";
    };
    "x86_64-darwin" = {
      url =
      ...
      sha256 = "sha256-p2cokUNWp7UJr0NbD1mzKrAnSfDN4/bPO8GQb9zVX4k=";
      type = "dmg";
    };
    "aarch64-darwin" = {
      url =
      ...
      sha256 = "sha256-eXiYCamDJ7I9QGAL4lh0XT2/xmaAtMeuf+XJSLczGFs=";
      type = "dmg";
    };
  };
