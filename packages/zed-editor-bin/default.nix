{
  ...
  assets = {
    ...
    "aarch64-linux" = {
      ...
      sha256 = "sha256-Yt+o3PyA7+97R1ea2EFfb6Z90GQiXSYilgeA+XrOZbc=";
      type = "tar.gz";
    };
    "x86_64-darwin" = {
      url =
      ...
      sha256 = "sha256-AiRWFPNZQGaZhYn8mdRyH5tss3VqHOAalXhf47P/DYQ=";
      type = "dmg";
    };
    "aarch64-darwin" = {
      url =
      ...
      sha256 = "sha256-cfT++svOADIzb10akWq7I4jUDrxZqMJ9Y4ymeeqv7os=";
      type = "dmg";
    };
  };
