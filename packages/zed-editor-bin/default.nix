{
  ...
  assets = {
    ...
    "aarch64-linux" = {
      ...
      sha256 = "sha256-vWGGE1zX+QnItIfony2h0L4ODIzr0742pwe5gjGUdJo=";
      type = "tar.gz";
    };
    "x86_64-darwin" = {
      url =
      ...
      sha256 = "sha256-HSV6sbAF224zi48GxMW1AEoiD+XmC6QGIHFjtjs981Q=";
      type = "dmg";
    };
    "aarch64-darwin" = {
      url =
      ...
      sha256 = "sha256-X3q++npaDmFFlrOLkPFoSbjWs27lge3gV+sxkJF+VDc=";
      type = "dmg";
    };
  };
