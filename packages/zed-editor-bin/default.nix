{
  ...
  assets = {
    ...
    "aarch64-linux" = {
      ...
      sha256 = "sha256-u3Nzwrq3uAklEDCoaz01CzHfQPajrlRU//Cvo61hh34=";
      type = "tar.gz";
    };
    "x86_64-darwin" = {
      url =
      ...
      sha256 = "sha256-5pEOEpdeauSThCwEOrOTeyiPlweuTBNd5soGiJnR4lM=";
      type = "dmg";
    };
    "aarch64-darwin" = {
      url =
      ...
      sha256 = "sha256-fbZUpnidVeg+j9LV0r5qqoM+X7DepwMVAOgy59QFnQg=";
      type = "dmg";
    };
  };
