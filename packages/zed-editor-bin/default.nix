{
  ...
  assets = {
    ...
    "aarch64-linux" = {
      ...
      sha256 = "sha256-TwPWbdKEs2JPVhbtoOtrR63w2g7I9xkFRhhp7wMm9jQ=";
      type = "tar.gz";
    };
    "x86_64-darwin" = {
      url =
      ...
      sha256 = "sha256-9S5XOw+Ds08cldP8NeMYTUdwkCU2JEmPPWTxRbkVb2U=";
      type = "dmg";
    };
    "aarch64-darwin" = {
      url =
      ...
      sha256 = "sha256-dV8gMmNQUxejDF5d489vbyBHsUFY1P3oNKLucpGcYHA=";
      type = "dmg";
    };
  };
