{
  ...
  assets = {
    ...
    "aarch64-linux" = {
      ...
      sha256 = "sha256-VLV8m0BHwCLHDTzjb3KqRf74Pa66jLF8qCR2WFOh0xc=";
      type = "tar.gz";
    };
    "x86_64-darwin" = {
      url =
      ...
      sha256 = "sha256-7DbZYZv2MtxhHzMowdgrF/FulYX9H1Y2izZB817Rm3I=";
      type = "dmg";
    };
    "aarch64-darwin" = {
      url =
      ...
      sha256 = "sha256-feb6L7KS6vHnuZ3sE97fSpfO6nhv/r+xybLAer7vu1s=";
      type = "dmg";
    };
  };
