{
  ...
  assets = {
    "x86_64-linux" = {
      ...
      sha256 = "sha256-whlnzNKzDcaZN5egcAWKKceMnGZSkd/uPaiOMNcYSJg=";
      type = "tar.gz";
    };
    "aarch64-linux" = {
      url =
      ...
      sha256 = "sha256-PABilXEfi+RFsUMvGXIQysP7sU8bUaKfu7d7dpagsBE=";
      type = "tar.gz";
    };
    "x86_64-darwin" = {
      url =
      ...
      sha256 = "sha256-CHDP4ph3HwnuXCvZxQcTmUpyFn7Na8/oea25BMvTpkc=";
      type = "dmg";
    };
    "aarch64-darwin" = {
      url =
      ...
      sha256 = "sha256-rtJU3rCwxFASCCDKkXcQr8rdK+qjmjJUpgTiKTOPBGY=";
      type = "dmg";
    };
  };
