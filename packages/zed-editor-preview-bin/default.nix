{
  ...
  assets = {
    ...
    "aarch64-linux" = {
      ...
      sha256 = "sha256-y1BvkVu851cjgwUVaOOTYmQ0qpCzw3hM9lfVCR9ZTtc=";
      type = "tar.gz";
    };
    "x86_64-darwin" = {
      url =
      ...
      sha256 = "sha256-6dYSjhROO8yYgLFcDt844Y8MDdn6Fj7d78adx6Z5PNk=";
      type = "dmg";
    };
    "aarch64-darwin" = {
      url =
      ...
      sha256 = "sha256-tWn1F90mO8AsTjJ333cG+Y1cF4v4bI29Zg65djqGDKM=";
      type = "dmg";
    };
  };
