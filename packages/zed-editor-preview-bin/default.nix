{
  ...
  assets = {
    ...
    "aarch64-linux" = {
      ...
      sha256 = "sha256-Vepwl2GO7KRyM4LjB2QOFYDU9EiHjeDj4veQQ/rH5CE=";
      type = "tar.gz";
    };
    "x86_64-darwin" = {
      url =
      ...
      sha256 = "sha256-ip6kAF78ZquWR2rKYkZxZOC9PU2Stkrhq6TOuDH34qc=";
      type = "dmg";
    };
    "aarch64-darwin" = {
      url =
      ...
      sha256 = "sha256-PLTRtGft4JiCMoj9vOrUsAj/5nEFNNGaRFI7PVLwjiI=";
      type = "dmg";
    };
  };
