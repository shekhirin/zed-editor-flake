{
  ...
  assets = {
    ...
    "aarch64-linux" = {
      ...
      sha256 = "sha256-oHbrYCUge0LVy27vz2PETPpJtIisX6HmpM+6YahaJ08=";
      type = "tar.gz";
    };
    "x86_64-darwin" = {
      url =
      ...
      sha256 = "sha256-C8Ge8Ym/bA+a1HTzRWJO5en5C2YREHZ6gckP1jhgvkw=";
      type = "dmg";
    };
    "aarch64-darwin" = {
      url =
      ...
      sha256 = "sha256-WPf4TWuGIzZkWbozZMAvgn8b1//djLHyy5w2PedZHU0=";
      type = "dmg";
    };
  };
