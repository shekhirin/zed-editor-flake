{
  ...
  assets = {
    ...
    "aarch64-linux" = {
      ...
      sha256 = "sha256-BEKoAVhvrVLOikt84snzRGT+/ZmYa/zdrEPYdpWZvYA=";
      type = "tar.gz";
    };
    "x86_64-darwin" = {
      url =
      ...
      sha256 = "sha256-ctVtGdc9ltH1QwIB9KcaBn2iY2APsGNKONEbGWdux1A=";
      type = "dmg";
    };
    "aarch64-darwin" = {
      url =
      ...
      sha256 = "sha256-lKYFOj17N+GxDcEkyvPYrLWkkkjjSwCgerR3XXao0Mk=";
      type = "dmg";
    };
  };
