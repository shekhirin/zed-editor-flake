{
  ...
  assets = {
    ...
    "aarch64-linux" = {
      ...
      sha256 = "sha256-Th+KKk1MnZoTdQ+qjWOpVfJpKe8lgZJAooTpC1MAiHg=";
      type = "tar.gz";
    };
    "x86_64-darwin" = {
      url =
      ...
      sha256 = "sha256-NxZ9WOYJMsOMaSt3GCg1PBXvAdLkDwiVdiXCug9fM2c=";
      type = "dmg";
    };
    "aarch64-darwin" = {
      url =
      ...
      sha256 = "sha256-9wKyplOopetzDkj1vdttmFfL52dLKmM/tSyIonb9K04=";
      type = "dmg";
    };
  };
