{
  ...
  assets = {
    ...
    "aarch64-linux" = {
      ...
      sha256 = "sha256-vKzgacuGRHzIy16KUy1gAAXxGFPDqIfrnb1tJkraZd0=";
      type = "tar.gz";
    };
    "x86_64-darwin" = {
      url =
      ...
      sha256 = "sha256-XHD1m1NCnIXEiHjRpJq61Kv0c3ITY7NLcg5Lwk3FJWo=";
      type = "dmg";
    };
    "aarch64-darwin" = {
      url =
      ...
      sha256 = "sha256-BZg/kMRWA7CKjEWUdLYTuTwUUSkTvTqyJZJ/Zw3+Ajc=";
      type = "dmg";
    };
  };
