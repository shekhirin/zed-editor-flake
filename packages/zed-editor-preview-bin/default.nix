{
  ...
  assets = {
    ...
    "aarch64-linux" = {
      ...
      sha256 = "sha256-M82qUtKfIhmojyFKdlPTeWjKgocdPkxilPW5JuTUa04=";
      type = "tar.gz";
    };
    "x86_64-darwin" = {
      url =
      ...
      sha256 = "sha256-8g1tFsm7EigukSj2NYHqOHwws4czuqkn0exBNBM5oog=";
      type = "dmg";
    };
    "aarch64-darwin" = {
      url =
      ...
      sha256 = "sha256-gizdClXBQ1RWiYkVfNNJ2oDD42vReLhbRKNVPcgpGbQ=";
      type = "dmg";
    };
  };
