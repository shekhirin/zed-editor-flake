{
  ...
  assets = {
    ...
    "aarch64-linux" = {
      ...
      sha256 = "sha256-yvZQ+YHNnOj8xkhDVYxwpTo1xsttuHu3SNJHmmFa8/c=";
      type = "tar.gz";
    };
    "x86_64-darwin" = {
      url =
      ...
      sha256 = "sha256-QbklkPLX+UebV2i2py12d6yzi+3C0KkuuWwNyS7xxVI=";
      type = "dmg";
    };
    "aarch64-darwin" = {
      url =
      ...
      sha256 = "sha256-atVD+LhT60PA0Gn5mt3RGDtK+V61slGGZ/qlVXi9QUg=";
      type = "dmg";
    };
  };
