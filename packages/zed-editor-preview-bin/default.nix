{
  ...
  assets = {
    ...
    "aarch64-linux" = {
      ...
      sha256 = "sha256-DIwvoG+SBYukSQ3XS5Ai83mseN6wh5kBjZY0KVMrVVg=";
      type = "tar.gz";
    };
    "x86_64-darwin" = {
      url =
      ...
      sha256 = "sha256-k30/WpjQ0I7+A52Y/sEG4R22/tW09ofcmAoFm+ezKy4=";
      type = "dmg";
    };
    "aarch64-darwin" = {
      url =
      ...
      sha256 = "sha256-f5pNFJePanC4VJgwla45L2nmysOEW/uFtm5crnyOqkE=";
      type = "dmg";
    };
  };
